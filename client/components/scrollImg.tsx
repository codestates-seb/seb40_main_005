    ...
    return (
        <>
            ...
            <div className="w-full z-50 text-base flex items-center justify-center bottom-5 fixed">
                ...
                <p className="ml-1 font-SCDream3 md:font-SCDream4 lg:font-SCDream5 text-xs md:text-sm lg:text-base text-gray-400">스크롤을 내려 Gallendar에 대해서 확인하세요!</p>
                {/* <p className="ml-3 font-SCDream3 text-sm text-gray-400">스크롤을 내려 확인하세요!</p> */}
            </div>
        </>
    )
}
